...
\section{计算机技能}
\cvline{机器学习}{熟悉RCNN，卷积神经网络算法，了解线性回归/Logistic Regression/聚类，numpy,pandas,matplotlib}
\cvline{编程语言}{C/C++ 设计模式 > Python } 
\cvline{Python 库}{numpy,sklearn,matplotlib,Keras,basemap}
\cvline{内核机制}{mca, signal, kthread,physical memory management, vfs, kernel driver}
...
\cvline{数据库}{mysql,elasticsearch,sqlite}
