...
\section{社区}
\cventry{Blog}{\url{https://www.lizhaozhong.info}}{技术博客}{}{}{}
...
\section{计算机技能}
\cvline{机器学习}{熟悉RCNN，卷积神经网络算法，了解线性回归/分类/SVM/聚类/决策树，可使用sklearn,pandas对数据进行预处理,可使用matplotlib对数据进行可视化}
\cvline{编程语言}{C/C++ 设计模式 > Python > Java > Shell} 
\cvline{Python 库}{numpy,sklearn,matplotlib,PIL,Keras,basemap}
\cvline{内核机制}{mca, signal, kthread,physical memory management, interruption, vfs, kernel driver}
\cvline{Toolchain}{gcc, gdb, cscope, ctags, make, cmake, Kdump Toolchain, LXC, Docker}
\cvline{框架}{Qt,PyQt}
\cvline{工具}{linux, vim, git, svn,\LaTeX, markdown, nginx}
\cvline{数据库}{mysql,sqlite}
